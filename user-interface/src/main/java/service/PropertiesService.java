...
public class PropertiesService {
    ...
    @Getter private static final String appWithHeaderFxmlPath = "/src/main/resources/appWithHeader.fxml";
    @Getter private static final String machinePageTemplateFxmlPath = "/src/main/resources/subcomponents/machinePageTemplate.fxml";
    @Getter private static final String machinePageWithIncludesFxmlPath = "/src/main/resources/subcomponents/machinePageTemplateWithInclude.fxml";
