...
public class HeaderController implements Initializable {
    ...
    @Getter @FXML Button dashboardSceneNavButton;
    @Getter @FXML Button contestSceneNavButton;


    @Override
    public void initialize(URL location, ResourceBundle resources) {
        dashboardSceneNavButton.disableProperty().bind(isLoggedInProperty.not());
        contestSceneNavButton.disableProperty().bind(isLoggedInProperty.not());
    ...
    @FXML
    void onChangeSceneToDashboardButtonClick(ActionEvent event) {
        if(parentController!=null){
